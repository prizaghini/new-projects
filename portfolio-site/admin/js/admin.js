...
const HIDDEN_MEDIA_FIELDS = [
  ...
  { file: "hero_bg_file_mobile", url: "hero_bg_url_mobile", remove: "remove_hero_bg", folder: "hero-bg", noteId: "hero-bg-mobile-note",
    setMsg: "A separate mobile background image is set. Uploading a new one replaces it.",
    unsetMsg: "No separate mobile image — the desktop background image above is reused (scaled to fit)." },
